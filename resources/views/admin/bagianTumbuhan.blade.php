...
<div class="card shadow mb-4">
    <div class="card-header py-3">
        <h6 class="m-0 font-weight-bold text-primary">DataTables Bagian Tumbuhan</h6>
        @if(session('success'))
                    ...
                    @foreach($bagian as $key => $value)
                        <tr>
                            ...
                            <td>
                                ...
                                data-target="#hapustanaman{{  $value->bagian }}">Delete</a>
                                <a href="" class="btn btn-warning">Update</a>
                            </td>
                        </tr>

                        {{-- Hapus Tanaman --}}
    <div class="modal fade" id="hapustanaman{{  $value->id_bagian }}" tabindex="-1" aria-labelledby="modalHapusBarang" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-body">
                <h4 class="text-center">Apakah anda yakin menghapus tanaman ini? : <span>{{ $value->nama_bagian }}</span></h4>
            </div>
        <div class="modal-footer">
            <form action="{{ route('unsur.destroy', [$value->id_bagian] ) }}" method="post">
            @csrf
            @method('delete')
...
<div class="modal fade" id="tambah-modal" tabindex="-1" aria-labelledby="modalTambahBarang" aria-hidden="true">
    ...
    <div class="modal-body">
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" id="nama_bagian" name="nama_bagian" aria-describedby="emailHelp">
        </div>
